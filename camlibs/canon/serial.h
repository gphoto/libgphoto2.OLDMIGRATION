...
unsigned char *canon_serial_dialogue (Camera *camera, unsigned char mtype, unsigned char dir,
				      int *len, ...);
int canon_serial_send_packet (Camera *camera, unsigned char type, unsigned char seq,
			      unsigned char *pkt, int len);
unsigned char *canon_serial_recv_packet (Camera *camera, unsigned char *type,
					 unsigned char *seq, int *len);
int canon_serial_wait_for_ack (Camera *camera);
unsigned char *canon_serial_recv_msg (Camera *camera, unsigned char mtype, unsigned char dir,
				      int *total);

int canon_serial_get_file (Camera *camera, const char *name, unsigned char **data, int *length);
int canon_serial_put_file (Camera *camera, CameraFile *file, char *destname, char *destpath);
int canon_serial_get_dirents (Camera *camera, unsigned char **dirent_data,
